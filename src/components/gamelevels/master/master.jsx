...
import Board3 from '../../board/index3';
import initializeDeckMaster from './deck3';
...
function Master() {
  ...
  return (
    <div className="App3">
      <h4><span><Link to="/">Memory Game</Link>&nbsp;<Link to="/about">About this app</Link></span></h4>
